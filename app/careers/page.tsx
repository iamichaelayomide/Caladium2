    ...
    <>
        ...
        <div className="container-shell relative z-10 grid gap-10 lg:grid-cols-[1.18fr_0.82fr] lg:items-end">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/76">
              Caladium is a place for thoughtful operators, analysts, and consultants who want
      ...
      <section className="section-padding border-y border-white/8 bg-[#070a11]">
        <div className="container-shell">
          <SectionLabel>Why Join Caladium</SectionLabel>
      ...
      <section className="section-padding bg-bg">
        <div className="container-shell">
          ...
          <h2 className="max-w-3xl font-bricolage text-[clamp(2.3rem,4vw,3.7rem)] font-semibold leading-[0.98] tracking-[-0.04em] text-white">
            Current opportunities at Caladium.
          </h2>

...
export type BlogPost = {
  slug: string;
  category: "Strategy" | "SME" | "Report" | "Founders" | "Operations" | "Go-To-Market";
  date: string;
  readTime: string;
  title: string;
  excerpt: string;
...
export const contactDetails = {
  ...
  emailHref: "mailto:hello@colodam.com",
  careersEmail: "careers@colodam.com",
...
export const stats = [
  { value: 95, suffix: "%", label: "Client Campaign Satisfaction", description: "Long-term relationships built on trust, clarity, and results." },
  { value: 15, suffix: "+", label: "Years of Combined Experience", description: "Senior brand strategists and creative operators with deep market insight." },
  { value: 200, suffix: "+", label: "Brands Supported", description: "Across brand strategy, creative production, campaigns, and performance analytics." },
  { value: 40, suffix: "%", label: "Avg Campaign Lift", description: "Clients report measurable revenue and performance improvement." }
] as const;

export const whyColodamTabs = [
  {
    id: "strategic-precision",
    title: "Strategic Precision",
    body: "Our work turns brand ambition into practical plans that teams can launch and sustain.",
    bullets: [
  ...
  },
  {
    ...
    body: "Every engagement is led by experienced brand experts with real African and international campaign experience.",
    bullets: [
  ...
  },
  {
    ...
    body: "We do not deliver generic frameworks. Every engagement is designed around your market, audience, and growth ambition.",
    bullets: [
      "No off-the-shelf brand templates",
  ...
  },
  {
    ...
    body: "We measure success by what lasts in your market after launch, not just by what looks good in a pitch deck.",
    bullets: [
  ...
  },
  {
    ...
    body: "We operate as partners, not vendors. You always know what we are shipping, why it matters, and how growth is measured.",
    bullets: [
...
export const serviceTabPanels = [
  {
    ...
    intro: "Our Brand Strategy service helps leadership teams make smarter decisions, define direction, and align around what matters most.",
  ...
  {
    id: "creative-production-systems",
    ...
    features: [
      { title: "Creative Production Ops & Redesign", description: "Map and redesign workflows for efficiency and control." },
  ...
  },
  {
    ...
    features: [
      { title: "Go-To-Market & Expansion", description: "Build the roadmap and support the move into new markets." },
...
export const testimonials = [
  {
    quote: "We came in with a messy strategy and left with a clear roadmap and aligned leadership team. Colodam stayed until the work was actually done.",
    name: "Chukwuemeka A.",
    title: "CMO, Lagos consumer brand",
  ...
  },
  {
    ...
    name: "Ngozi O.",
    title: "Head of Marketing, Nigerian fintech group",
    image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=900&q=80"
  },
  {
    quote: "The brand sprint gave us clarity on voice, visuals, and campaign priorities in one week.",
    name: "Adebayo F.",
    title: "Founder, D2C startup, Abuja",
  ...
  },
  {
    ...
    name: "Amaka N.",
    title: "Managing Director, lifestyle brand, Lagos",
  ...
  },
  {
    ...
    name: "Tunde I.",
    title: "Growth Lead, Nigerian e-commerce brand",
  ...
  },
  {
    ...
    name: "Funke B.",
    title: "Brand Director, pan-African retail group",
...
export const teamMembers: TeamMember[] = [
  { name: "Aderonke Adebiyi", title: "Managing Partner", bio: "Leads strategy engagements and brand leadership mandates across African enterprises.", image: "https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
  ...
  { name: "Ifeoma Nwosu", title: "Director, Operations & Creative Production Ops", bio: "Designs high-performance operating models and workflow redesign programs.", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
  { name: "Emeka Okorie", title: "Senior Consultant, Brand Identity Systems", bio: "Builds governance, leadership structures, and culture systems for scale.", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
  { name: "Mariam Bello", title: "Principal, Campaign Analytics & Performance", bio: "Supports budgeting, forecasting, controls, and performance improvement.", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
  { name: "Chinonso Eze", title: "Research Lead, SME Intelligence", bio: "Leads Colodam research programs and proprietary market studies.", image: "https://images.unsplash.com/photo-1546961329-78bef0414d7c?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
  { name: "David Osei", title: "Go-To-Market Specialist", bio: "Supports expansion strategy, partnerships, and go-to-market planning.", image: "https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
  { name: "Adaeze Nnamani", title: "Brand Transformation Consultant", bio: "Guides leaders through restructuring, communication, and adoption.", image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
...
export const services: Service[] = [
  {
    ...
    features: ["Brand Strategy", "Brand Narrative Architecture", "Audience & Competitor Analysis", "Positioning & Messaging", "Campaign Launch Strategy", "Brand Growth Roadmap"],
  ...
  },
  {
    ...
    shortName: "Brand Identity Systems",
  ...
  },
  {
    ...
    features: ["Market Research & Analysis", "Entry Strategy Development", "Platform & Channel Readiness", "Partnership & Alliance Building", "Go-to-Market Execution", "Growth Scaling & Optimization"],
  ...
  },
  {
    ...
    name: "Campaign Analytics & Performance",
    shortName: "Campaign Analytics & Performance",
    ...
    features: ["Campaign Analytics & Reporting", "Media Budgeting & Forecasting", "CAC Optimization", "Conversion Rate Improvement", "Funnel Health Monitoring", "Attribution & Tracking"],
  ...
  },
  {
    ...
    shortName: "Creative Production Ops",
  ...
  },
  {
    ...
    name: "Audience Research & Insight",
    ...
    features: ["Audience Data Strategy", "Competitive Intelligence", "Marketing Performance Dashboards", "Customer & Market Insights", "Campaign Feasibility Studies", "Consumer Insight Research"],
  ...
  },
  {
    ...
    shortName: "Brand Transformation",
    ...
    features: ["Brand Repositioning Strategy", "Stakeholder Engagement", "Communication Management", "Training & Capability Building", "Adoption & Reinforcement", "Change Impact Assessment"],
  ...
  },
  {
    ...
    name: "Brand Setup & Launch Support",
    ...
    features: ["Brand Naming Direction", "Brand Story Deck", "Content Calendar Templates", "Channel & Platform Readiness", "MarTech Stack Setup", "Launch Foundation"],
    ...
    subServices: [{ title: "Launch Readiness", description: "Get the compliance and operating essentials in place." }, { title: "Founder Toolkit", description: "Create pitch materials, templates, and foundational business assets." }, { title: "Launch Foundations", description: "Set up simple systems that support disciplined early execution." }],
...
const simpleBody = (focus: string): BlogPost["body"] => ({
  intro: [
    `Colodam publishes research and branding insight to help leaders make sharper decisions around ${focus}.`,
    "Our perspective combines brand strategy, creative execution, and practical realities of scaling in African markets."
  ],
  sections: [
...
export const blogPosts: BlogPost[] = [
  { slug: "driving-business-success", category: "Strategy", date: "March 2025", readTime: "6 min read", title: "Driving Business Success: How Colodam Shapes African Enterprise", excerpt: "In a rapidly evolving business environment, staying ahead requires more than ambition. Here is how our approach is helping Nigerian businesses thrive.", coverImage: "https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("brand strategy and growth") },
  { slug: "business-struggling-asking-for-help", category: "SME", date: "February 2025", readTime: "5 min read", title: "Is Your Business Struggling? It's Not Failing - It's Asking for Help", excerpt: "Most businesses do not collapse overnight. The warning signs are always there. The key is knowing how to read them and what to do next.", coverImage: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("creative refresh and growth") },
  { slug: "2024-sme-report", category: "Report", date: "2024", readTime: "8 min read", title: "The 2024 Colodam Nigeria SME Report: Key Findings", excerpt: "We interviewed over 1,500 businesses and industry experts to uncover the real challenges and opportunities in Nigeria's business landscape.", coverImage: "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("audience insight and trends") },
  { slug: "founders-clarity-session-lessons", category: "Founders", date: "January 2025", readTime: "5 min read", title: "What the Founders Clarity Session Has Taught Us About Nigerian Startups", excerpt: "Patterns emerge quickly when founders bring their toughest questions into the same room. These are the ones we keep seeing.", coverImage: "https://images.unsplash.com/photo-1515169067868-5387ec356754?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("founder brand clarity and growth") },
  { slug: "founder-led-to-founder-limited", category: "Operations", date: "January 2025", readTime: "6 min read", title: "When Founder-Led Becomes Founder-Limited: The Case for Redesign", excerpt: "What made the business work at NGN50M can actively slow it down at NGN500M. Growth requires a different operating design.", coverImage: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("campaign system redesign") },
  { slug: "expanding-across-africa", category: "Go-To-Market", date: "December 2024", readTime: "7 min read", title: "Expanding Across Africa: What Nigerian Businesses Get Wrong", excerpt: "Ambition is not the hard part. The hard part is choosing the right market, the right timing, and the right operating model.", coverImage: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("market positioning and expansion") },
  { slug: "five-kpis-for-smes", category: "Strategy", date: "November 2024", readTime: "4 min read", title: "The 5 KPIs Every Nigerian SME Should Be Tracking Right Now", excerpt: "The point of KPIs is not reporting. It is decision quality. These five measures give leaders a clearer picture of performance.", coverImage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("marketing KPI discipline") },
  { slug: "founder-led-to-board-governed", category: "Founders", date: "October 2024", readTime: "7 min read", title: "How to Transition From Founder-Led to Board-Governed in 18 Months", excerpt: "Governance maturity does not happen by accident. It needs sequencing, discipline, and a willingness to let structure catch up with ambition.", coverImage: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("brand governance and scaling") },
  { slug: "nigerian-business-landscape-2025", category: "Report", date: "2025", readTime: "8 min read", title: "Nigerian Business Landscape 2025: What Our Research Reveals", excerpt: "What is shaping leadership decisions in 2025? Our latest research points to a clearer pattern than many expect.", coverImage: "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("the brand and consumer landscape") }
];

export const careers: Career[] = [
  { slug: "strategy-consultant", title: "Brand Strategist", location: "Lagos, Nigeria", type: "Hybrid", summary: "Join our core branding team to lead strategic planning, market analysis, and growth initiatives for corporate clients across Africa.", overview: ["You will work directly with senior consultants and client leaders on strategic recommendations.", "The role suits sharp thinkers with strong business judgment and structured communication."], responsibilities: ["Lead strategic analysis across engagements", "Develop client-ready recommendations", "Support growth, strategy, and market-entry work", "Contribute to thought leadership and internal development"], requirements: ["3-5 years in strategy branding or corporate strategy", "Strong analytical and communication skills", "Comfort with client workshops and executive material", "African market exposure is an advantage"], benefits: ["Hybrid work model", "Direct partner exposure", "High-impact client work", "Structured mentorship"] },
  { slug: "operations-analyst", title: "Creative Operations Analyst", location: "Lagos, Nigeria", type: "On-site", summary: "Support our clients in optimizing systems, processes, and operations through analysis, redesign, and KPI tracking.", overview: ["You will diagnose bottlenecks and support workflow redesign across sectors.", "The role combines analytical discipline with client-facing collaboration."], responsibilities: ["Map processes and identify waste", "Support KPI design and reporting", "Prepare analysis for process engineering work", "Test and refine redesigned workflows"], requirements: ["2-4 years in operations, analysis, or process improvement", "Strong spreadsheet capability", "Clear documentation skills", "Exposure to Lean Six Sigma is helpful"], benefits: ["Hands-on delivery exposure", "Continuous learning", "Growth into branding leadership", "High-ownership role"] },
  { slug: "change-manager", title: "Brand Transformation Lead", location: "Lagos / Remote", type: "Hybrid", summary: "Help clients navigate transformation with empathy, structure, and disciplined communication planning.", overview: ["You will design adoption plans, engagement strategies, and change communications.", "The role requires strong people judgment and structured thinking."], responsibilities: ["Design change management strategies", "Develop communication materials", "Assess adoption risk", "Support leadership teams through transformation"], requirements: ["4+ years in change management or organizational development", "Strong facilitation and communication skills", "Ability to manage sensitive stakeholder dynamics", "Transformation exposure preferred"], benefits: ["Hybrid flexibility", "Cross-sector change work", "Leadership exposure", "Professional development support"] },
  { slug: "financial-advisory-associate", title: "Campaign Analytics & Performance Associate", location: "Lagos, Nigeria", type: "On-site", summary: "Work with our campaign analytics team on budgeting, forecasting, and financial modeling engagements.", overview: ["You will support management reporting, commercial analysis, and forecasting work.", "The role suits someone who enjoys detail and financially grounded decision support."], responsibilities: ["Build forecasting and scenario models", "Support reporting projects", "Prepare insight summaries", "Assist with control and performance reviews"], requirements: ["2-4 years in marketing analytics or performance", "Strong Excel and modeling skills", "ACA, ACCA, CFA, or equivalent progression preferred", "Clear business writing ability"], benefits: ["Deep campaign exposure", "Mentorship from senior finance leaders", "Structured capability growth", "Meaningful client impact"] },
  { slug: "client-engagement-coordinator", title: "Client Success Coordinator", location: "Lagos, Nigeria / Remote", type: "Hybrid", summary: "Be the connection between clients and branding teams, ensuring alignment, communication, and project momentum.", overview: ["You will maintain project rhythm and client responsiveness across engagements.", "The role sits at the center of delivery quality and relationship management."], responsibilities: ["Coordinate timelines and client communications", "Track deliverables and momentum", "Prepare meeting notes and action logs", "Support a high-quality client experience"], requirements: ["2-5 years in coordination or client service", "Excellent organization and communication", "Comfort with multiple priorities and stakeholders", "Professional services exposure is helpful"], benefits: ["Hybrid structure", "Client-facing responsibility", "Cross-functional learning", "Clear advancement path"] },
  { slug: "research-associate", title: "Audience Insights Associate", location: "Remote", type: "Remote", summary: "Support strategy projects with competitive research, market trend analysis, and insight reporting.", overview: ["You will contribute to strategic work by gathering evidence and shaping insight-led recommendations.", "The role is ideal for a curious and detail-oriented analyst."], responsibilities: ["Conduct market and competitor research", "Synthesize findings into concise briefs", "Support survey and interview workstreams", "Contribute to thought leadership and reports"], requirements: ["Strong research and writing ability", "Background in business, economics, social science, or data", "Comfort working independently in a remote environment", "Experience with desk research and slide writing"], benefits: ["Remote flexibility", "Exposure to strategic work", "Strong mentorship", "Research-to-branding growth path"] }
];

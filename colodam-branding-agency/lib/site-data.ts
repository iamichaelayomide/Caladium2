...
export const contactDetails = {
  ...
  email: "enquiries@colodam.com",
  emailHref: "mailto:enquiries@colodam.com",
...
export const stats = [
  ...
  { value: 200, suffix: "+", label: "Organizations Supported", description: "Across strategy, operations, campaign analytics, and transformation." },
...
export const serviceTabPanels = [
  ...
  {
    id: "operational-branding",
    title: "Operational Branding",
...
export const teamMembers: TeamMember[] = [
  ...
  { name: "Mariam Bello", title: "Principal, Campaign Analytics", bio: "Supports budgeting, forecasting, controls, and performance improvement.", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=900&q=80", linkedin: "#" },
...
const simpleBody = (focus: string): BlogPost["body"] => ({
  intro: [
    `Colodam publishes research and advisory insight to help leaders make sharper decisions around ${focus}.`,
...
export const blogPosts: BlogPost[] = [
  { slug: "driving-business-success", category: "Strategy", date: "March 2025", readTime: "6 min read", title: "Driving Business Success: How Colodam Shapes African Enterprise", excerpt: "In a rapidly evolving business environment, staying ahead requires more than ambition. Here is how our approach is helping Nigerian businesses thrive.", coverImage: "https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("strategy and growth") },
  { slug: "business-struggling-asking-for-help", category: "SME", date: "February 2025", readTime: "5 min read", title: "Is Your Business Struggling? It's Not Failing - It's Asking for Help", excerpt: "Most businesses do not collapse overnight. The warning signs are always there. The key is knowing how to read them and what to do next.", coverImage: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("SME pressure and turnaround") },
  { slug: "2024-sme-report", category: "Report", date: "2024", readTime: "8 min read", title: "The 2024 Colodam Nigeria SME Report: Key Findings", excerpt: "We interviewed over 1,500 businesses and industry experts to uncover the real challenges and opportunities in Nigeria's business landscape.", coverImage: "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("SME research and insight") },
  { slug: "founders-clarity-session-lessons", category: "Founders", date: "January 2025", readTime: "5 min read", title: "What the Founders Clarity Session Has Taught Us About Nigerian Startups", excerpt: "Patterns emerge quickly when founders bring their toughest questions into the same room. These are the ones we keep seeing.", coverImage: "https://images.unsplash.com/photo-1515169067868-5387ec356754?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("founder clarity and growth") },
  { slug: "founder-led-to-founder-limited", category: "Operations", date: "January 2025", readTime: "6 min read", title: "When Founder-Led Becomes Founder-Limited: The Case for Redesign", excerpt: "What made the business work at NGN50M can actively slow it down at NGN500M. Growth requires a different operating design.", coverImage: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("operating redesign") },
  { slug: "expanding-across-africa", category: "Market Entry", date: "December 2024", readTime: "7 min read", title: "Expanding Across Africa: What Nigerian Businesses Get Wrong", excerpt: "Ambition is not the hard part. The hard part is choosing the right market, the right timing, and the right operating model.", coverImage: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("market positioning and expansion") },
  { slug: "five-kpis-for-smes", category: "Strategy", date: "November 2024", readTime: "4 min read", title: "The 5 KPIs Every Nigerian SME Should Be Tracking Right Now", excerpt: "The point of KPIs is not reporting. It is decision quality. These five measures give leaders a clearer picture of performance.", coverImage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("KPI discipline") },
  { slug: "founder-led-to-board-governed", category: "Founders", date: "October 2024", readTime: "7 min read", title: "How to Transition From Founder-Led to Board-Governed in 18 Months", excerpt: "Governance maturity does not happen by accident. It needs sequencing, discipline, and a willingness to let structure catch up with ambition.", coverImage: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("governance and founder transition") },
  { slug: "nigerian-business-landscape-2025", category: "Report", date: "2025", readTime: "8 min read", title: "Nigerian Business Landscape 2025: What Our Research Reveals", excerpt: "What is shaping leadership decisions in 2025? Our latest research points to a clearer pattern than many expect.", coverImage: "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=1200&q=80", author: "Colodam Research Team", body: simpleBody("the business landscape") }
];

export const careers: Career[] = [
  { slug: "strategy-consultant", title: "Strategy Consultant", location: "Lagos, Nigeria", type: "Hybrid", summary: "Join our core branding team to lead strategic planning, market analysis, and growth initiatives for corporate clients across Africa.", overview: ["You will work directly with senior consultants and client leaders on strategic recommendations.", "The role suits sharp thinkers with strong business judgment and structured communication."], responsibilities: ["Lead strategic analysis across engagements", "Develop client-ready recommendations", "Support growth, strategy, and market-entry work", "Contribute to thought leadership and internal development"], requirements: ["3-5 years in strategy branding or corporate strategy", "Strong analytical and communication skills", "Comfort with client workshops and executive material", "African market exposure is an advantage"], benefits: ["Hybrid work model", "Direct partner exposure", "High-impact client work", "Structured mentorship"] },

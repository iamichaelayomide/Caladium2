...
const fallbackServicesPage: ServicesPageContent = {
  heroTitle: "Consulting support designed to move the business forward.",
  heroDescription:
    "From strategic planning to operating model design and market entry, every Caladium engagement is structured for practical execution and durable outcomes.",
...
const fallbackTeamPage: TeamPageContent = {
  heroTitle: "Meet the Caladium team.",
  heroDescription:

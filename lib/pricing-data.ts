...
export const pricingTiers: PricingTier[] = [
  {
    ...
    cadence: "Lifetime",
    description:
      "A zero-cost community layer for founders and small teams who want guidance, partnership, and ongoing access to Caladium's startup network.",
    features: [
      "Business management support",
      "Interactive training access",
      "Partnership platform entry",
      "Business mentorship with Caladium",
